...
class ImprovedNet_256(nn.Module):
    def __init__(self, n_classes: int) -> None:
        super(ImprovedNet_256, self).__init__()
        ...
        self.cnn_layers = nn.Sequential(
            ...
            # # try posibly removing this or adding another layer if the loss function becomes too stable.
            nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1),
            nn.BatchNorm2d(128),  # make it your out_channels
            activation_func,
            nn.MaxPool2d(kernel_size=2, stride=2),

            nn.Conv2d(128, 256, kernel_size=3, stride=1, padding=1),
            nn.BatchNorm2d(256),  # make it your out_channels
            activation_func,
            nn.MaxPool2d(kernel_size=2, stride=2),

            nn.Conv2d(256, 6, kernel_size=1, stride=1, padding=1),
